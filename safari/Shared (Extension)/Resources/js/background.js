...
function onMessage(request, sender, callback) {
    ...
    console.log("TEMP: Got a message! ", request.what);
    ...
    if ( sender.origin !== undefined && sender.origin !== UBOL_ORIGIN ) { console.log("TEMP: origin not match! ", sender.origin, UBOL_ORIGIN); return; }
    ...
    case 'getOptionsPageData': {
        console.log("TEMP: getOptionsPageData");
        Promise.all([
            getDefaultFilteringMode(),
            getTrustedSites(),
            getRulesetDetails(),
...
async function start() {
    console.log("TEMP: background starting...");
...
//      Safari has not support for getAvailableStaticRuleCount(), disable it for now.
